...
### EE. 프레임 격차는 인코드 격차다 — 두 계기가 4% 안에서 만난다
...
되고 호출부는 전부 fastcall이 된다. 23,992 → 12,741 ns/패킷, **1.9x**, 예측 프레임레이트
**84 → 약 101 FPS (Blink 대비 1.28x, §6 기준 1.3x 안쪽)**. Studio 매트릭스가 확인하기 전까지는
예측이다.
